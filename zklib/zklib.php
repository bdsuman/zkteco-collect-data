<?php    
    class ZKLib {
        ...
        */
        ...
        public function dataSend($uid,$datetime,$base_url) {
            return data_send($uid, $datetime,$base_url);
        }

        public function userSave($uid,$name,$role,$password,$base_url) {
            return user_save($uid,$name,$role,$password,$base_url);
        }
